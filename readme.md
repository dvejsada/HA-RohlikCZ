...
> [!NOTE]
> The current release is **1.0.0-beta3**, a pre-release of the upcoming 1.0.0. It is feature-complete but still being tested — see [Installing the beta](#installing-the-beta) below, and please [report anything you run into](https://github.com/dvejsada/HA-RohlikCZ/issues).
...
4. Pick `v1.0.0-beta3` and download it.
